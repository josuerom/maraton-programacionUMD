...
/**
 * Este algoritmo muestra correctamente los primeros 30 números perfectos. Su complejidad en Notación Big O es
 * de O(n^2) ya que entre mayor es el número de datos de entrada mayor será tiempo le toma entregar la salida.
 * @author josuerom
 * @see 01/10/22
 */
